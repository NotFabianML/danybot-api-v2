...
#Eliminar esta funcion, fue remplazada por get_rack en archivo preterencestool.py
...
# Eliminar esta funcion, se remplaza con la funcion get_deck_coordinates de preferencestools.py
